...
if file:
   ...
   # st.write(df.head(50))###########
    ...
    df1= df.iloc[:,:22]#######  removeing extra ASIN columns at the end   
    df1 = df1.fillna(0)
    # st.write(df1.head(50))

    df2= df1.iloc[:,[3,4,9,19,21]]###################### selecting only required 5 columns
    ...
    scaling = RobustScaler()  # Default parameters are suitable for most cases
